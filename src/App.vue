...
<template>
  ...
  <header>
    <div class="fixed z-30 w-full mt-5">
      <nav class="mx-6 bg-white shadow-md rounded-[24px] px-5 py-2 relative text-white">
        <div class="container mx-auto flex items-center md:justify-between">
          <div class="flex items-center lg:gap-16 justify-between w-full md:justify-start">
            <a href="./" class="w-full max-w-[117px]">
              <img src="@/assets/img/proxper.png" alt="Logo proxper" width="117" loading="lazy" />
            </a>
          ...
          <div class="hidden md:flex justify-end items-center">
            ...
            <div class="hidden lg:block static w-[218px]">
  ...
  <main>
    ...
    <button class="fixed bottom-5 right-5 z-50 p-4 bg-[#1ab0de] text-white rounded-full border border-[#1ab0de] shadow-lg" @click="scrollToTop" v-show="showScrollTopButton" aria-label="Ir al inicio">
  ...
  <footer class="bg-[#4B2A7E] text-white mx-6 mb-6 rounded-[64px] py-10">
    <div class="container mx-auto px-4">
      ...
      <div class="flex flex-wrap justify-between -m-4 items-center pb-12">
        <div class="w-full sm:w-1/2 md:w-3/5 p-4 py-0">
