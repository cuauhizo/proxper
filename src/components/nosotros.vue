<template>
  <section id="section3" class="container grid gap-3 md:gap-12 justify-items-center items-center py-10 relative md:py-20" data-aos-anchor-placement="center-bottom">
    <div class="text-center p-6 px-3 md:p-12 space-y-4 shadow-md rounded-[64px] bg-white text-[#24395F] w-full md:max-w-[845px]" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
      ...
      <h2 class="lato-bold text-[2.138rem]">Expertos en Seguridad Financiera en México</h2>
      ...
      <p class="mb-6 text-[0.938rem]">
        ...
        la empatía hacia los intereses de cada asegurado. Consideramos que la protección financiera y el seguro de vida son base fundamental para el bienestar de la familia, teniendo como objetivo final llevar tranquilidad a los hogares de las
        familias mexicanas.
      </p>
    </div>
    <div class="absolute -top-28 left-10 -z-10">
      <img src="@/assets/img/pleca_3.png" class="w-[118px]" alt="" width="118" />
    </div>
    <div class="absolute -bottom-80 right-10 -z-10">
      <img src="@/assets/img/pleca_4.png" class="w-[76px]" alt="" width="76" />
    </div>
  </section>
</template>
